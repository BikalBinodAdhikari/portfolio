...
const settings = {
  ...
  const experience = {
    ...
    sections: [
      ...
      },
      {
        ...
        experiences: [
          {
            title: "International Youth Conference on Science, Technology and Innovation",
            company: "Nepal Government",
            company_url: "http://202.45.147.168/news/45",
            logo_path: "International Youth Conference on Science, Technology and Innovation.png",
  ...
  const contactPageData = {
    ...
    addressSection: {
      title: "Address",
      subtitle:
        "Mahadevsthan Marga, Koteshwor, Kathmandu, Nepal",
